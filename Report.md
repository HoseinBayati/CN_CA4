...
<ul style="list-style-type: none">
    ...
    <li>
     ...
     <li>
        <h2>
            <strong style="color: yellow">
                  پاسخ سوالات و تحلیل نتایج
            </strong>
        </h2>
            <br/>
            <h3>
کنترل ازدحام به معنی آن است که ساست هایی برای آنکه مانع ایجاد ازدحام شویم یا در صورت وقوع ازدحام شریان های ورودی را چگونه برای کنترل ازدحام مدیریت کنیم را در بر میکیرد مثلا پکت های ارسالی را نصف میکنیم
اما در کنترل جریان ما به مدریت پکت هایی که ارسال اولیه آنها انجام شده و وارد مسیر شدند میشویم مثلا به بعضی پکت های مهم اولویت میدهیم
الگورتم نیو رنو نیز مانند رنو عمل کرده از مکانیزم ها اسلو استارت و استفاده از ترشهلد مانند رنو عمل میکند اما در ریکاوری به صورت سلکتیو عمل میکند و فقط آن چیزهایی که میس شده اند را ارسال میکند
بی بی آر نیز به سرعت حجم ارسالی را بالا میبرد تا بندویت را پیدا کند سپس سرعت را کم میکند تا آنهایی که برای فهمیدن بندویت در صف هستند بروند و سپس با میانگینی که تخمین زده است ارسال میکند
پرتکل وگاس را پرتکل متفاوتی از این سه است که مزیت وی برآنها این است که مانع از ایجاد ازدحام میشود و برای کنترل جریان هم برنامه دارد
تفاوت دو الکوریتم اول در نوع ریکاوری است
الکوریتم سوم تفاوت های رزیادی با آن دو دارد که در جواب سوالات اول و دوم شرح داده شد
خیر در هر حالتی ممکن است یکی برتری داشته باشد مثلا درجایی که لاست ها به علت نویز به طور دسته ای رخ میدهند رنو معمولی ممکن است برتر باشد یا جایی که امکانات کم است ممکن است نیو رنو برتر باشد  
